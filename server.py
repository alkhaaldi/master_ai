...
Upgrades from v4:
  ...
  2. Iterative Planning Loop (planÃ¢ÂÂexecuteÃ¢ÂÂverifyÃ¢ÂÂreplan)
...
class HACallServiceAction(BaseModel):
    ...
    def validate_args(cls, v):
        if "domain" not in v or "service" not in v:
            # Try to fix common format: "light.turn_on" Ã¢ÂÂ domain=light, service=turn_on
...
try:
    ...
    logger.warning("memory_db not available Ã¢ÂÂ using stub")
...
# Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
# [UPGRADE 5] OBSERVABILITY Ã¢ÂÂ Tracing
# Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
# ═══════════════════════════════════════════════════════════════
# EVENT PROCESSOR — Glue between EventEngine + iterative_engine (v5.2)
# ═══════════════════════════════════════════════════════════════
...
async def process_event(event: dict):
    ...
    if not cfg.get("enabled", False):
        event_engine.update_event(eid, status="skipped", result="autonomy disabled")
        return

    if risk == "high" and not cfg.get("allow_high", False):
        event_engine.update_event(eid, status="waiting_approval", result="high risk - needs approval")
        logger.info(f"Event {eid} HIGH risk - waiting approval")
        return

    if risk == "medium" and not cfg.get("allow_medium", False):
        event_engine.update_event(eid, status="waiting_approval", result="medium risk - needs approval")
        logger.info(f"Event {eid} MEDIUM risk - waiting approval")
        return
...
- ha_get_state: {entity_id} Ã¢ÂÂ get HA entity state (use "*" for all)
- ha_call_service: {domain, service, service_data} Ã¢ÂÂ call HA service
- ssh_run: {cmd} Ã¢ÂÂ run shell command on Raspberry Pi
- respond_text: {text} Ã¢ÂÂ respond to user with text
- win_diagnostics: {checks[]} Ã¢ÂÂ run Windows diagnostics
- win_powershell: {script} Ã¢ÂÂ run PowerShell on Windows PC
- win_winget_install: {package} Ã¢ÂÂ install via winget
- http_request: {url, method, headers, body} Ã¢ÂÂ HTTP request
- memory_store: {category, content, type} Ã¢ÂÂ store to long-term memory
...
Rules:
- For simple questions/greetings Ã¢ÂÂ mode: single_step, next_step: respond_text, task_state: complete
- For device control Ã¢ÂÂ mode: single_step or multi_step with ha_call_service actions
- For complex tasks Ã¢ÂÂ mode: multi_step with a plan array
- If you need more info before continuing Ã¢ÂÂ task_state: waiting
- Always include "response" with a user-facing message in Arabic
- NEVER invent entity IDs Ã¢ÂÂ use ONLY from the entity map above
"""
...
async def plan_step(goal: str, context: dict = None, trace: RequestTrace = None,
    ...
    """Single planning step Ã¢ÂÂ LLM generates next action(s)."""
    ...
    if not parsed:
        ...
        return {
            "mode": "single_step",
            "next_step": {"type": "respond_text", "args": {"text": "ÃÂ¹ÃÂ°ÃÂ±ÃÂ§ÃÂÃÂ ÃÂÃÂ§ÃÂ¬ÃÂÃÂª ÃÂÃÂ´ÃÂÃÂÃÂ© ÃÂÃÂ ÃÂÃÂ¹ÃÂ§ÃÂÃÂ¬ÃÂ© ÃÂ§ÃÂÃÂ·ÃÂÃÂ¨"}},
            "task_state": "complete",
            "response": "ÃÂ¹ÃÂ°ÃÂ±ÃÂ§ÃÂÃÂ ÃÂÃÂ§ÃÂ¬ÃÂÃÂª ÃÂÃÂ´ÃÂÃÂÃÂ© ÃÂÃÂ ÃÂÃÂ¹ÃÂ§ÃÂÃÂ¬ÃÂ© ÃÂ§ÃÂÃÂ·ÃÂÃÂ¨",
            "_parse_error": True
        }
...
async def iterative_engine(goal: str, context: dict = None, trace: RequestTrace = None,
    ...
    """
    [UPGRADE 2] Iterative planning loop: plan Ã¢ÂÂ execute Ã¢ÂÂ verify Ã¢ÂÂ replan
    ...
    while iteration < max_iterations:
        ...
        if mode == "multi_step" and "plan" in plan:
            ...
            actions = [{"type": "respond_text", "args": {"text": final_response or "ÃÂªÃÂ"}}]
        ...
        if task_state == "complete":
            ...
            break
        # else: "running" Ã¢ÂÂ loop continues with results fed back to planner
...
# Ã¢ÂÂÃ¢ÂÂ /ask Ã¢ÂÂ Main chat endpoint Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
async def ask(body: AskRequest):
    ...
    if task_id:
        ...
        if "continue task" in msg_lower or "ÃÂÃÂÃÂ ÃÂ§ÃÂÃÂÃÂÃÂÃÂ©" in msg_lower:
    ...
    try:
        ...
        result = {"response": f"ÃÂ®ÃÂ·ÃÂ£: {e}", "actions": [], "results": [], "task_state": "failed", "iterations": 0}
...
# Ã¢ÂÂÃ¢ÂÂ /agent Ã¢ÂÂ Telegram/external agent endpoint Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
...
async def agent_endpoint(body: AgentRequest):
    """Agent endpoint Ã¢ÂÂ same iterative engine, different interface."""
    trace = RequestTrace()
    ...
    try:
        ...
        TaskManager.fail_task(task_id, str(e))
        return {"response": f"ÃÂ®ÃÂ·ÃÂ£: {e}", "task_id": task_id}
...
SHIFT_NAMES = {"A": "Morning Ã¢ÂÂÃ¯Â¸Â", "B": "Evening Ã°ÂÂÂ", "C": "Night Ã°ÂÂÂ", "D": "Off Ã°ÂÂÂ "}
...
async def claude_context():
    ...
    context = {
        ...
        "capabilities": [
            "Iterative planning (planÃ¢ÂÂexecuteÃ¢ÂÂverifyÃ¢ÂÂreplan)",
...
async def deploy_file(body: DeployRequest):
    """Deploy a file to the server (backward compat Ã¢ÂÂ prefer Git workflow)."""
...
#   3. update.sh will: pull Ã¢ÂÂ syntax check Ã¢ÂÂ restart Ã¢ÂÂ health check Ã¢ÂÂ rollback if failed
#
